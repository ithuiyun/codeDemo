...
/**
 * 自定义key实现WritableComparable接口，覆盖compareTo方法
 *
 * Created by ithuiyun.com on 2018/4/28.
 */
public class SortWordCountApp1 {
    /**
     * 驱动代码【组装job的代码】
     * @param args
     */
    public static void main(String[] args) throws Exception {
        ...
        //表示job名称，一般建议使用类名
        String jobName = SortWordCountApp1.class.getSimpleName();
        //把所有的内容都封装到job中
        Job job = Job.getInstance(conf, jobName);
        //程序打jar包必备代码
        job.setJarByClass(SortWordCountApp1.class);
